...
export function searchExcerpt(content, searchQuery, contextLength = 80) {
  const strippedContent = convert(content);
  ...
  const highlightedQuery = `<span className="bg-zinc-100 text-zinc-600">${strippedContent.slice(
    matchIndex,
